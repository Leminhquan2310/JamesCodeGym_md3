package exam.codegym.usermanager.controller;

import exam.codegym.usermanager.model.User;
import exam.codegym.usermanager.dao.UserDAO;
...
public class UserServlet extends HttpServlet {
    ...
    private void listUser(HttpServletRequest request, HttpServletResponse response)
        ...
        List<String> listCountry = userDAO.selectListCountry();
    ...
    private void searchByCountry(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean isShowAll = countrySearch.isEmpty();
        List<User> users = isShowAll ? userDAO.selectAllUsers() : userDAO.selectUsersByCountry(countrySearch);
        List<String> countries = userDAO.selectListCountry();
    ...
    private void sortName(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<String> countries = userDAO.selectListCountry();
        List<User> users = userDAO.selectOrderBy(orderBy);
        request.setAttribute("listUser", users);
        request.setAttribute("listCountry", countries);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
